...
namespace ITD.Finanzas.API.Controllers
{
    ...
    {
        private readonly IConfiguracionesLogic _configuracionesLogic;

        public ConfiguracionesController(IConfiguracionesLogic configuracionesLogic)
        {
            _configuracionesLogic = configuracionesLogic;
        ...
        [ProducesResponseType(typeof(List<ConfiguracionesResponse>), (int)StatusResult.Success)]
        [ProducesResponseType(typeof(ErrorResponse), (int)StatusResult.badRequest)]
        public async Task<IActionResult> Get(int id)
        {
            return Ok(await _configuracionesLogic.Get(id));
        }
